...
export default function Hero() {
  return (
    <section className=" relative max-sm:mx-[-20px] mt-6 mb-14 py-10 flex max-lg:flex-wrap justify-between lg:justify-between items-center gap-5 md:gap-9 lg:gap-14 xl:gap-16 min-h-[400px] md:min-h-[500px] lg:min-h-[500px] xl:min-h-[600px] 2xl:min-h-[700px] md:rounded-md">
      <img
        loading="lazy"
        src={hero}
