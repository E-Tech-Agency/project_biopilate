...
export default function Hero() {
  return (
    <section className=" relative max-sm:mx-[-20px] mt-6 mb-14 py-10 flex max-lg:flex-wrap justify-between lg:justify-between items-center gap-5 md:gap-9 lg:gap-14 xl:gap-16 min-h-[440px] md:min-h-[610px] xl:min-h-[680px] md:rounded-md">
      <img
        loading="lazy"
        src={hero}
