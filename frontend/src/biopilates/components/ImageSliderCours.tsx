...
export default function ImageSliderCours({ list, action }: ImageSliderCoursProps) {
  ...
  return (
    ...
    <div className={` flex flex-col justify-center max-md:items-center px-3 xl:px-2 md:px-5 ${isMobile ? 'mobile-text-class' : 'lg:min-w-[40%] lg:max-w-[50%]'} gap-5 font-lato`}>
