...
export default function SideNav() {
  ...
  return (
    <div className="hidden lg:flex border-r border-bgColor bg-white min-w-64 font-lato h-screen  flex-col justify-between">
      <div>
        ...
        <div className="flex flex-col gap-2">
          <nav className="flex-1 overflow-auto py-2 grid items-start text-base font-lato">
            ...
            >
              {isActive("/dashboard") && <ActiveLinkSVG />} {/* Use the SVG */}
