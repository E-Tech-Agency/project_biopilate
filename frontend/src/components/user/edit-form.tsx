...
export function EditForm() {
  ...
  return (
    <Card className="flex flex-col md:flex-row shadow-lg rounded-xl bg-gradient-to-r p-6 text-white mx-auto w-full max-w-4xl">
      <div className="md:w-1/3 flex flex-col items-center justify-center">
        ...
        <h2 className="text-2xl text-marron font-semibold">
      ...
      <div className="md:w-2/3 mt-4 md:mt-0 md:ml-8 bg-white rounded-lg p-6 text-gray-800 shadow-md">
        ...
        <form onSubmit={handleSubmit} encType="multipart/form-data">
          <div className="grid gap-6">
            ...
            <div className="grid gap-2">
              <Label htmlFor="profile-image" className="text-gray-700">
                Image de profil
              </Label>
              <Input
                id="profile-image"
