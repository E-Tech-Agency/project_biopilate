                        ...
                        <form onSubmit={handleSubmit}>
                            <div className="grid gap-6">
                                <div className="grid gap-3">
                                    <Label htmlFor="title">Question <br />{errors.title && <li className="text-red-500 mt-2">{errors.title}</li>}</Label>
                                    <Input
                                        id="title"
                                        name="title"
                                        type="text"
                                ...
                                <div className="grid gap-3">
                                    <Label htmlFor="description">Response <br />{errors.description && <li className="text-red-500 mt-2">{errors.description}</li>}</Label>
                                    <textarea
                                        id="description"
                                        name="description"
                                ...
                                <div className="grid gap-3">
                                    <Label htmlFor="range">Movement <br />{errors.range && <li className="text-red-500 mt-2">{errors.range}</li>}</Label>
                                    <Input
                                        id="range"
                                        name="range"
                                        type="number"
                                        className="w-full"
                                        value={faq.range}
                                        onChange={(e) => setFaq({ ...faq, range: Number(e.target.value) })} // Convert string to number
                                    />
                                </div>
                                <div className="grid gap-3">
                                ...
                                <br/>
                                <div>
                                    <Button type="submit" className="w-44" size={"lg"}>Add</Button>
                                </div>
                            </div>
                        </form>
                    </CardContent>
