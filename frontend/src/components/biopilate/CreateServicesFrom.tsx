            ...
            <CardContent>
                <form onSubmit={handleSubmit}>
                    <div className="grid gap-6">
                        ...
                        <div className="grid gap-3">
                            <Label htmlFor="status">Status <br />{errors.status && <li className="text-red-500 mt-2">{errors.status}</li>}</Label>
                            <select
                                id="status"
                                name="status"
                        ...
                        <div className="grid gap-3">
                            <Label htmlFor="instructeur">Instructeur {errors.instructeur && <li className="text-red-500 mt-1">{errors.instructeur}</li>}</Label>
                            <select
                                id="instructeur"
                                name="instructeur"
                                value={service.instructeur}
                                onChange={(e) => setService({ ...service, instructeur: e.target.value })}
                                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm"
                            >
                        ...
                        <div className="grid gap-3">
                            <Label htmlFor="image">Image {errors.image && <li className="text-red-500 mt-1">{errors.image}</li>}</Label>
                            <Input
                                id="image"
                                name="image"
                                type="file"
                        ...
                        <div className="grid gap-3">
                            <Label htmlFor="full_text">Texte Complet {errors.full_text && <li className="text-red-500 mt-1">{errors.full_text}</li>}</Label>
